...
\newcommand{\bxy}{\bm{g}(\bx)}%{\bx^Y}
\newcommand{\bxyt}{\bxy^\prime}%{\bx^{Y\prime}}
...
%\newcommand{\r}{R}
\newcommand{\geepers}{\textsc{geepers}\xspace}
\newcommand{\psw}{\textsc{psw}\xspace}
\newcommand{\pmm}{\textsc{pmm}\xspace}
